...
class TestBlackBox(object):
    ...
    def test_simple_mod_nugget(self):
        ...
        enzyme_entity = Protoform("P00533", regions=[enz_reg], residues=[enz_res])

        sub_bound_1 = Protoform("P28482", states=[State("activity", True)])
        sub_bound_2 = Protoform("P28482", states=[State("activity", True)])

        substrate_entity = Protoform("P04049", bound_to=[sub_bound_1, sub_bound_2])
    ...
    def test_phospho_semantics(self):
        ...
        print(corpus._hierarchy.get_relation(
            "test_action_graph", "semantic_action_graph"))
        print(corpus)
    ...
    def test_sh2_py_semantics(self):
        ...
        assert(
            (nugget_id, "sh2_pY_binding_semantic_nugget") in corpus.nugget_relations())
    ...
    def test_multiple_sh2(self):
        ...
        frs2_py196 = Protoform(
            "Q8WU20",
            synonyms=["FRS2"],
            residues=[Residue("Y", 196, phos)]
        )
        frs2_py349 = Protoform(
            "Q8WU20",
            synonyms=["FRS2"],
    ...
    def test_regionactor(self):
        ...
        m = Modification(
            enzyme=Protoform("P00519"),
            substrate=RegionActor(
                Protoform("P00533", regions=[
    ...
    def test_siteactor(self):
        ...
        m = Modification(
            enzyme=Protoform(enz_uniprot),
            substrate=SiteActor(
                protoform=Protoform(sub_uniprot),
    ...
    def test_advanced_site_actor(self):
        ...
        m = Modification(
            enzyme=Protoform("P00519", hgnc_symbol="ABL1"),
            substrate=SiteActor(protoform=Protoform("P00519", hgnc_symbol="ABL1"),
        ...
        m = Modification(
            enzyme=Protoform("P00519", hgnc_symbol="ABL1"),
            substrate=SiteActor(protoform=Protoform("P00533", hgnc_symbol="EGFR"),
                                site=Site(name="site800", start=796, end=804)),
            target=Residue("Y", 800, State("phosphorylation", False)),
            value=True
        )
        ...
        b = Binding(
            ...
            SiteActor(protoform=Protoform("P00533", hgnc_symbol="EGFR"),
                      site=Site(name="site800", start=796, end=804)),
            RegionActor(protoform=Protoform("P62993", hgnc_symbol="GRB2"), region=sh2)
        )
        inters.append(b)
        corpus = KamiCorpus("test")
        corpus.add_interactions(inters, anatomize=True)
    ...
    def test_site_residue_reconnect(self):
        sh2 = Region(name="SH2")
        b = Binding(
            SiteActor(protoform=Protoform(uniprotid="P00533", hgnc_symbol="EGFR",
                                residues=[
                                    Residue(
                                        "Y", 1092,
                                        state=State("phosphorylation", True))]),
